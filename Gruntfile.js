  ...
  grunt.initConfig({
	...
	files:{
	  "build/<%= pkg.name %>.js":[
	    ...
	    "src/rgb.js",
	    "src/color.js",
	    "src/cardinal-string.js",
	    "src/cardinal-strings.js",
	    "src/cardinal-counter.js",
	    "src/list-style.js",
	    "src/flow.js",
	    "src/block-flow.js",
	    "src/inline-flow.js",
	    ...
	    "src/page-generator.js",
	    "src/inline-block-generator.js",
	    "src/child-page-generator.js",
	    ...
	    "src/para-child-page-generator.js",
